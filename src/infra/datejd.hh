...
class DateJd {
  ...
  public:
    ...
    DateJd(const char*, bool aYearHigh, char sep = ':');
  public:
  ...
  public:
    inline uint get_jd() const { return _jd; }
    inline void set_jd(const uint aJd) { _jd = aJd; }
  ...
  public:
    ...
    static void jd2ymd(const uint aJulianDay, int& y, int& m, int& d);
