...
class SamplingAlphaOmegaNewton {
  ...
  public:
    ...
    double pmfDerivative(unsigned long long N, unsigned long long n, unsigned long long k, double x);

    double fDerivative(unsigned long long N, unsigned long long n, unsigned long long k, double x);
  private:
